...
# modified from convert_dataset_to_KITTI/py
...
def parse_args():
    ...
    ap.add_argument('-o',
                    '--output_dir',
                    default='/media/lzy/14BA7CD7BA7CB6B8/lzy_2022/DataSets/jrdb2kitti/training',
                    help='location to store dataset in KITTI format')
    ap.add_argument('-i',
                    '--input_dir',
                    default='/media/lzy/14BA7CD7BA7CB6B8/lzy_2022/DataSets/JRDB/train_dataset_with_activity',
