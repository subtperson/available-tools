...
def draw_box_in_single_image(image_path, txt_path, save_path):
    ...
    for i in range(len(pos)):
        ...
        if 1:
            ...
            cv2.putText(image,label,(box[0],box[1]-2), 0, 0.3, [0,255,0], thickness=1, lineType=cv2.LINE_AA, )
        pass
...
img_folder = "/media/lzy/14BA7CD7BA7CB6B8/lzy_2022/DataSets/RGBTDronePerson/val/thermal"
img_list = os.listdir(img_folder)
img_list.sort()

label_folder = "/media/lzy/14BA7CD7BA7CB6B8/lzy_2022/DataSets/RGBTDronePerson/val/v5labels"
label_list = os.listdir(label_folder)
label_list.sort()

save_folder = "/media/lzy/14BA7CD7BA7CB6B8/lzy_2022/DataSets/RGBTDronePerson/val/vis"
