...
# 将ir图像进行仿射变换，与rgb图像对齐
img_dir = '/media/lzy/14BA7CD7BA7CB6B8/lzy_2022/mm_person/rgbt26/ir' # ir图像路径
save_dir = img_dir.replace('ir_ori', 'ir_trans')
if not os.path.exists(save_dir):
    os.mkdir(save_dir)

source_points = [[368, 142], [89, 121], [506, 456]] # ir图像的源点
target_points = [[1002, 413], [611, 381], [1204, 855]] # rgb图像的目标点
